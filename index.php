...
<head>
    ...
    <title>PERPUSTAKAAN STIKOM El RAHMA</title>
	<!-- BOOTSTRAP STYLES-->
...
session_start();
    if (empty ($_SESSION['username']) AND empty($_SESSION['passuser'])) {
        ...
        echo "<center> Untuk mengakses admin El Rahma LIBRARY <br> <b> anda harus login terlebih dahulu</b>";
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">EL RAHMA LIBRARY</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a href="?page=admin"><i class="fa fa-users fa-2x"></i> Admin</a>
                    </li>
